...
import 'package:e_commerce_products/detail_product.dart'; // Import your ProductDetailsPage
                    ...
                    child: Column(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.asset(
                            'images/product.jpg', // Ensure this image path is correct in your pubspec.yaml
                            fit: BoxFit.cover,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => const AppProduct(),
            ),
          );
        },
